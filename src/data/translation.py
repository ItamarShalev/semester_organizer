from src.data.case_insensitive_dict import TextCaseInsensitiveDict
...
data = TextCaseInsensitiveDict({
    ...
    "Show English speaker courses:": "הצג קורסים של דוברי אנגלית:",
    ...
    "Enter the courses you did indexes separated by comma (example: 1,2,20): ": "הקלד את מספרי המזהה של הקורסים שכבר עשית מופרדים בפסיק (לדוגמא: 1,2,20): ",
    ...
    "Show english courses of ESP: ": "הצג קורסים לדוברי אנגלית: ",
    "Explain: Show or don't show the courses for English Speaker Program.": "הסבר: הצג או אל תציג את הקורסים של תוכנית דוברי האנגלית.",
    ...
    "Anyway, courses you do now or didn't pass will not be added.": "בכל מקרה, קורסים שאתה עושה עכשיו או לא עברת לא יתווספו.",
