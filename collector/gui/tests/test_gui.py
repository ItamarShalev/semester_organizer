...
class TestGui:
    ...
    def test_personal_activities(self):
        ...
        tested_activities = gui.open_personal_activities_window()
    ...
    def test_settings(self):
        ...
        excepted_settings = gui.open_settings_window(Settings(), ["לב", "טל"], {5782: "תשפב", 5783: "תשפג"})
    ...
    def test_academic_activities(self):
        ...
        actual_course_choices = gui.open_academic_activities_window(False, course_choice_dict)
